...
CHEF_SERVER_NAME="MyChefAutomateServer" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="mychefautomateserver-t8hkmqkvii1px8tb.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
