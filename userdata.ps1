<powershell>
 ...
 $env:CHEF_SERVER_NAME = "MyChefAutomateServer" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "mychefautomateserver-t8hkmqkvii1px8tb.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
